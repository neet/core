...
import { PushSubscriptionAlerts } from './push-subscription';
...
export class PushController {
   ...
   */
  @version({ since: '2.4.0' })
  createSubscription(params: CreatePushSubscriptionParams) {
   ...
   */
  @version({ since: '2.4.0' })
  updateSubscription(params: UpdatePushSubscriptionParams) {
    return this.http.put<PushSubscription>('/api/v1/push/subscription', params);
  }
