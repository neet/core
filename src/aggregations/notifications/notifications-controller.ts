...
export class NotificationsController implements AsyncIterable<Notification[]> {
   ...
   */
  @version({ since: '0.0.0' })
  getIterator(params?: FetchNotificationsParams) {
    return new Paginator<typeof params, Notification[]>(
      this.http,
